...
import { addBanner } from '../../redux/Actions/BannerActions';
...
export const AddStatisticsBannerForm = (props) => {
                        ...
                        <div className="w-full flex h-screen">
                            ...
                            <div className="w-full xl:w-[65%] md:w-full bg-white rounded-lg ">
                                ...
                                <Formik
                                    ...
                                    initialValues={
                                        {
                                            bannerImage : editItem.length !== 0 ? `${editItem[0].bannerImage}` : '',
                                        } 
                                    }
                                            ...
                                            <div className="flex mx-auto justify-center">
                                                <div className=" md:mr-2 md:mb-0 md:w-full justify-center mx-auto">
                                                    <label htmlFor="upload" className='w-[120px] h-[120px] block rounded-[50%] cursor-pointer mx-auto mb-2'>
                                                        <img className='w-[125px] h-[125px] block rounded-[50%] cursor-pointer mb-2 ' src={!status && editItem.length !== 0 && !imgCheck ? baseURL + editItem[0].bannerImage : !values.bannerImage ? ImageHolder : filePreview} alt='img' />
                                                    ...
                                                    <label className="block mb-2 text-sm font-bold text-gray-700 md:mt-2 text-center " name='bannerImage'>
                                                        Banner Image
                                                    </label>
                                                    <ErrorMessage className='text-red-600 text-xs text-center' name="bannerImage" component="div" />
                                                </div>
                                            </div>
