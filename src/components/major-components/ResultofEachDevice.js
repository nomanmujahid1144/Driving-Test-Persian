...
import { getResultofEachDevice } from "../../redux/Actions/AnswersActionn";
...
export const ResultofEachDevice = () => {
    ...
    useEffect(() => {
        dispatch(getResultofEachDevice(alert));
    }, [isUpdateOpen, isOpen])
                    ...
                    <div className=" mt-24  ml-[20%]  w-[78%]">
                        <div className="py-2 bg-gray-50">
                            <div className=' bg-white rounded-lg  shadow-lg'>
                                ...
                                <ActionsTable isOpen={isUpdateOpen} tableColumnsReal={tableColumnsReal} checkBox={true} isResultofEachDevice={true} modal={setIsUpdateOpen} key={parseInt(Math.random() * 10000)} tableDataReal={answers}  />
                            </div>
                        </div>
                    </div>
                ) : (
