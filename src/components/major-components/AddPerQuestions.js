...
import { getEngCategoryQuestions, getPerCategoryQuestions } from "../../redux/Actions/QuestionsAction"
                        ...
                        <div className="py-2 bg-gray-50">
                            <div className=' bg-white rounded-lg  shadow-lg'>
                                ...
                                <Modal open={isOpen} onClose={() => setIsOpen(false)} >
                                    <AddPerQuestionForm modal={setIsOpen} isAdd={true} />
                                </Modal>
